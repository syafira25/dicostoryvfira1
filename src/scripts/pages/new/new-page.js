...
export default class NewPage {
  ...
  #setupForm() {
    ...
    this.#form.addEventListener('submit', async (event) => {
      ...
      // Ambil foto pertama saja (sesuai requirement API)
    ...
    // Perbaiki typo pada variabel (insertingPicturesPromises -> insertingPicturesPromises)
    ...
    // Perbaiki selector untuk klik dokumen input
